...
public class ProductController {
    ...
    public String saveProduct(@ModelAttribute("productDto") ProductDto product,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "New product has been added successfully!");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public String updateProduct(@ModelAttribute("productDto") ProductDto productDto,
        ...
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Product has been updated successfully!");
        } catch (Exception e) {
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Failed to update, please try again!");
        }
        return "redirect:/products/0";
    }
    ...
    public String enabledProduct(Long id, RedirectAttributes redirectAttributes, Principal principal) {
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Product has been enabled successfully!");
        } catch (Exception e) {
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Failed to enable, please try again!");
        }
        return "redirect:/products/0";
    }
    ...
    public String deletedProduct(Long id, RedirectAttributes redirectAttributes, Principal principal) {
        try {
            ...
            redirectAttributes.addFlashAttribute("success", "Product has been deleted successfully!");
        } catch (Exception e) {
            e.printStackTrace();
            redirectAttributes.addFlashAttribute("error", "Failed to delete, please try again!");
        }
        return "redirect:/products/0";
    }
}